...
env $'\xde\xad\xbe\xef'=$'\xca\xfe\xba\xbe' ./input A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A $'\0' $' \n\r' 29001 A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A A 0< /tmp/bh/stdio.dat 2< /tmp/bh/stderr.dat > readable_flag.dat&nc localhost 29001 < /tmp/bh/netcat.dat > /tmp/bh/netcat.out;
